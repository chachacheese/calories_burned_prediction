...
\
    ...
    plt.title("Stage-by-Stage RMSE Improvement \'97 Key Turning Points", fontsize=22, fontweight="bold")\
\
...
\
    ...
    ax.set_title(f"Calorie Prediction \'97 RMSE Progression (\{start_rmse:.2f\} \uc0\u8594  \{end_rmse:.2f\}, -\{improvement_pct_total:.0f\}%)",\
